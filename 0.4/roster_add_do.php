...
if($fname && $lname && $sex && $dob && $level && $proglang)
{
    ...
    <!-- The btn classes in bootstrap can be applied to hypertexts as seen below -->
    <!-- btn-primary: blue button -->
    <p><a href=\"roster_add.php\" class=\"btn btn-primary\">Add Another?</a></p>";
	}
	else
	{
		echo "
    ...
    <p><a href=\"roster_add.php\" class=\"btn btn-primary\">Back</a></p>\n";
	}
}
else
{
    ...
    <p><a href=\"roster_add.php\">Go Back</a></p>\n";
}
$con->close();
?>
